...
const AdminSidebar = ({ collapsed }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        {
          name: "Theo lượt mua gói mới",
          href: "/admin/customers/statistics_packages",
        },
        {
          name: "Theo lượt đăng kí mới",
          href: "/admin/customers/statistics_customer",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: Package,
      children: [
        { name: "Thống kê gói", href: "/admin/packages" },
  ...
  const renderMenuItem = (item) => {
    ...
    return (
      <div
        ...
        className="relative"
        onMouseEnter={() =>
          collapsed && hasChildren && handleMouseEnter(item.name)
        }
            ...
            >
              <ChevronRight
                ...
                className={`transition-transform ${
                  openMenus[item.name] ? "rotate-90" : "rotate-0"
                }`}
              />
            </button>
          )}
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b-2 border-blue-200 flex items-center justify-center">
        ...
        >
          <div
            className={`flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 transition-all duration-300 ${
