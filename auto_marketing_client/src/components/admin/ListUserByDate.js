...
function ListUserByDate() {
    ...
    return (
        <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
            ...
            {/* Form tìm kiếm */}
            <div
                className={`bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 ${showMobileFilter ? "block" : "hidden sm:block"}`}>
                <div className="p-4 sm:p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div className="space-y-1 relative">
                            ...
                            />
                            {errors.startDate && (
                                <p className="text-red-500 text-xs mt-1 absolute top-full left-0">{errors.startDate}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-1 relative">
                            ...
                            />
                            {errors.endDate && (
                                <p className="text-red-500 text-xs mt-1 absolute top-full left-0">{errors.endDate}</p>
                            )}
                        </div>

                        <div
                            className="flex flex-col sm:flex-row gap-3 sm:gap-2 items-stretch sm:items-end sm:col-span-2 lg:col-span-1">
                            <button
                                onClick={() => {
                                    if (handleValid()) {
                                        setPage(1);
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="overflow-x-auto">
                    <table
                        className="w-full text-left min-w-[500px] sm:min-w-[700px] md:min-w-[800px] lg:min-w-[900px]">
                        ...
                        <span
                            className="font-medium text-gray-900 truncate max-w-[80px] sm:max-w-[120px] md:max-w-[140px] lg:max-w-[160px] text-xs sm:text-sm">
                          {customer.name}
                        </span>
            ...
            {showDetail && selectedUser && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-2 sm:p-4">
                    <div
                        className="bg-white rounded-lg shadow-xl relative w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            {totalPages &&
                <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mt-4 sm:mt-6">
                    <div className="flex items-center space-x-1">
                        ...
                        {(() => {
                            const visiblePages = 3; // chỉ 3 trang thôi
                            let startPage = Math.max(1, page - Math.floor(visiblePages / 2));
                            let endPage = startPage + visiblePages - 1;

                            // nếu endPage vượt quá tổng số trang thì dịch ngược lại
